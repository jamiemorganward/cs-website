 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query SEO {\n  _site {\n    globalSeo {\n      siteName\n      titleSuffix\n      twitterAccount\n      fallbackSeo {\n        description\n        title\n        twitterCard\n      }\n      facebookPageUrl\n    }\n  }\n}"): (typeof documents)["query SEO {\n  _site {\n    globalSeo {\n      siteName\n      titleSuffix\n      twitterAccount\n      fallbackSeo {\n        description\n        title\n        twitterCard\n      }\n      facebookPageUrl\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "fragment FeaturedProject on ProjectRecord {\n  projectName\n  slug\n  openGraphImage {\n    ...Image\n  }\n}\n\nquery HomePage {\n  homePage {\n    headline\n    headerLogo {\n      url\n    }\n    featuredProject {\n      ...FeaturedProject\n    }\n  }\n}"): (typeof documents)["fragment FeaturedProject on ProjectRecord {\n  projectName\n  slug\n  openGraphImage {\n    ...Image\n  }\n}\n\nquery HomePage {\n  homePage {\n    headline\n    headerLogo {\n      url\n    }\n    featuredProject {\n      ...FeaturedProject\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query GetAllRDProjects {\n  allRdProjects {\n    ...RDProject\n  }\n}\n\nquery GetRDProject($slug: String) {\n  rdProject(filter: {slug: {eq: $slug}}) {\n    ...RDProject\n  }\n}\n\nfragment RDProject on RdProjectRecord {\n  projectName\n  slug\n  year\n  featuredMedia {\n    ...Image\n    ...Video\n  }\n  flexibleContent {\n    ...DoubleImage\n    ...TextSingle\n    ...SingleImage\n  }\n}"): (typeof documents)["query GetAllRDProjects {\n  allRdProjects {\n    ...RDProject\n  }\n}\n\nquery GetRDProject($slug: String) {\n  rdProject(filter: {slug: {eq: $slug}}) {\n    ...RDProject\n  }\n}\n\nfragment RDProject on RdProjectRecord {\n  projectName\n  slug\n  year\n  featuredMedia {\n    ...Image\n    ...Video\n  }\n  flexibleContent {\n    ...DoubleImage\n    ...TextSingle\n    ...SingleImage\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
