...
const documents = {
  ...
  'fragment FeaturedProject on ProjectRecord {\n  projectDescription\n  slug\n  openGraphImage {\n    ...Image\n  }\n}\n\nquery HomePage {\n  homePage {\n    headline\n    headerLogo {\n      url\n    }\n    featuredProject {\n      ...FeaturedProject\n    }\n  }\n}':
    types.FeaturedProjectFragmentDoc,
  ...
  'query GetAllRDProjects {\n  allRdProjects {\n    ...RDProject\n  }\n}\n\nquery GetRDProject($slug: String) {\n  rdProject(filter: {slug: {eq: $slug}}) {\n    ...RDProject\n  }\n}\n\nfragment RDProject on RdProjectRecord {\n  projectName\n  slug\n  year\n  featuredMedia {\n    ...Image\n    ...Video\n  }\n  flexibleContent {\n    ...DoubleImage\n    ...TextSingle\n    ...SingleImage\n  }\n}':
    types.GetAllRdProjectsDocument,
...
export function graphql(
  source: 'fragment Video on FileField {\n  video {\n    streamingUrl\n    mp4High: mp4Url(res: high)\n    mp4Med: mp4Url(res: medium)\n    mp4Low: mp4Url(res: low)\n    duration\n    framerate\n    thumbJpg: thumbnailUrl(format: jpg)\n    thumbPng: thumbnailUrl(format: png)\n    thumbGif: thumbnailUrl(format: gif)\n  }\n}\n\nfragment FeaturedMedia on FileField {\n  ...Video\n  ...Image\n}\n\nfragment Partner on PartnershipRecord {\n  client\n  featuredVideo\n  service\n  yearStarted\n  alignment\n  themeColour {\n    hex\n  }\n}\n\nfragment CardSection on CardRecord {\n  title\n  subtitle\n  textContent {\n    value\n  }\n}\n\nquery AboutPage {\n  aboutPage {\n    blurb\n    cardSection {\n      ...CardSection\n    }\n    longStandingPartnerships {\n      ...Partner\n    }\n    ourServices {\n      ...CardSection\n    }\n    officeImage {\n      ...Image\n    }\n  }\n}'
): (typeof documents)['fragment Video on FileField {\n  video {\n    streamingUrl\n    mp4High: mp4Url(res: high)\n    mp4Med: mp4Url(res: medium)\n    mp4Low: mp4Url(res: low)\n    duration\n    framerate\n    thumbJpg: thumbnailUrl(format: jpg)\n    thumbPng: thumbnailUrl(format: png)\n    thumbGif: thumbnailUrl(format: gif)\n  }\n}\n\nfragment FeaturedMedia on FileField {\n  ...Video\n  ...Image\n}\n\nfragment Partner on PartnershipRecord {\n  client\n  featuredVideo\n  service\n  yearStarted\n  alignment\n  themeColour {\n    hex\n  }\n}\n\nfragment CardSection on CardRecord {\n  title\n  subtitle\n  textContent {\n    value\n  }\n}\n\nquery AboutPage {\n  aboutPage {\n    blurb\n    cardSection {\n      ...CardSection\n    }\n    longStandingPartnerships {\n      ...Partner\n    }\n    ourServices {\n      ...CardSection\n    }\n    officeImage {\n      ...Image\n    }\n  }\n}']
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: 'query ApproachPage {\n  approachPage {\n    blurb\n    postProjectCards {\n      ...CardSection\n    }\n    fffCards {\n      ...CardSection\n    }\n  }\n}'
): (typeof documents)['query ApproachPage {\n  approachPage {\n    blurb\n    postProjectCards {\n      ...CardSection\n    }\n    fffCards {\n      ...CardSection\n    }\n  }\n}']
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: 'query getAllCustomWorkProjects($slug: String) {\n  customWorkPage(filter: {slug: {eq: $slug}}) {\n    slug\n    title\n    projects {\n      ...ProjectOnWorkPage\n    }\n  }\n}'
...
export function graphql(
  source: 'query SEO {\n  _site {\n    globalSeo {\n      siteName\n      titleSuffix\n      twitterAccount\n      fallbackSeo {\n        description\n        title\n        twitterCard\n      }\n      facebookPageUrl\n    }\n  }\n}'
): (typeof documents)['query SEO {\n  _site {\n    globalSeo {\n      siteName\n      titleSuffix\n      twitterAccount\n      fallbackSeo {\n        description\n        title\n        twitterCard\n      }\n      facebookPageUrl\n    }\n  }\n}']
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: 'fragment FeaturedProject on ProjectRecord {\n  projectDescription\n  slug\n  openGraphImage {\n    ...Image\n  }\n}\n\nquery HomePage {\n  homePage {\n    headline\n    headerLogo {\n      url\n    }\n    featuredProject {\n      ...FeaturedProject\n    }\n  }\n}'
): (typeof documents)['fragment FeaturedProject on ProjectRecord {\n  projectDescription\n  slug\n  openGraphImage {\n    ...Image\n  }\n}\n\nquery HomePage {\n  homePage {\n    headline\n    headerLogo {\n      url\n    }\n    featuredProject {\n      ...FeaturedProject\n    }\n  }\n}']
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: 'fragment Person on PersonRecord {\n  id\n  name\n  jobTitle\n  headshot {\n    ...Image\n    ...Video\n  }\n  inOfficeVideo {\n    ...Image\n    ...Video\n  }\n  outOfOfficeVideo {\n    ...Image\n    ...Video\n  }\n}\n\nquery GetAllPeople {\n  allPeople {\n    ...Person\n  }\n}'
): (typeof documents)['fragment Person on PersonRecord {\n  id\n  name\n  jobTitle\n  headshot {\n    ...Image\n    ...Video\n  }\n  inOfficeVideo {\n    ...Image\n    ...Video\n  }\n  outOfOfficeVideo {\n    ...Image\n    ...Video\n  }\n}\n\nquery GetAllPeople {\n  allPeople {\n    ...Person\n  }\n}']
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: 'query GetProject($slug: String) {\n  project(filter: {slug: {eq: $slug}}) {\n    ...Project\n  }\n}\n\nquery GetLatestProject {\n  allProjects(first: "1", orderBy: _createdAt_DESC) {\n    ...ProjectThumb\n  }\n}\n\nquery GetProjectList {\n  allProjects {\n    ...NextProject\n  }\n}\n\nfragment NextProject on ProjectRecord {\n  client\n  slug\n  year\n  id\n}\n\nfragment ProjectOnWorkPage on ProjectRecord {\n  ...ProjectThumb\n  multiCategory\n  client\n  slug\n  year\n  projectDescription\n  featuredImage {\n    ...Image\n  }\n  featuredVideo\n  alignment\n  themeColour {\n    hex\n  }\n}\n\nfragment ProjectThumb on ProjectRecord {\n  projectHeadline\n  projectUrl\n  multiCategory\n  featuredImage {\n    ...Image\n    ...Video\n  }\n  featuredVideo\n}\n\nfragment Image on FileField {\n  responsiveImage {\n    alt\n    src\n    sizes\n    base64\n    height\n    title\n    width\n  }\n}\n\nfragment Project on ProjectRecord {\n  multiCategory\n  client\n  id\n  slug\n  ourRole\n  projectHeadline\n  projectUrl\n  year\n  projectDescription\n  alignment\n  themeColour {\n    hex\n  }\n  openGraphImage {\n    ...Image\n  }\n  metaDescription\n  featuredImage {\n    ...Image\n    ...Video\n  }\n  featuredVideo\n  flexibleContent {\n    ...DoubleImage\n    ...TextTwoColumn\n    ...TextSingle\n    ...SingleImage\n    ...Quote\n  }\n}\n\nfragment DoubleImage on DoubleImageBlockRecord {\n  id\n  imageRight {\n    alt\n    ...Video\n    ...Image\n  }\n  videoRight\n  heightRight\n  imageLeft {\n    alt\n    ...Video\n    ...Image\n    url\n  }\n  videoLeft\n  heightLeft\n}\n\nfragment TextTwoColumn on TextTwoColumnBlockRecord {\n  id\n  textRightColumn {\n    blocks\n    links\n    value\n  }\n  textLeftColumn {\n    blocks\n    links\n    value\n  }\n}\n\nfragment TextSingle on TextSingleBlockRecord {\n  id\n  textBlockAlignment\n  textSingle {\n    blocks\n    links\n    value\n  }\n}\n\nfragment SingleImage on SingleImageBlockRecord {\n  id\n  fullwidth\n  image {\n    url\n    ...Video\n    ...Image\n  }\n  video\n}\n\nfragment Quote on QuoteBlockRecord {\n  id\n  quote {\n    value\n    links\n    blocks\n  }\n  quotee\n}'
): (typeof documents)['query GetProject($slug: String) {\n  project(filter: {slug: {eq: $slug}}) {\n    ...Project\n  }\n}\n\nquery GetLatestProject {\n  allProjects(first: "1", orderBy: _createdAt_DESC) {\n    ...ProjectThumb\n  }\n}\n\nquery GetProjectList {\n  allProjects {\n    ...NextProject\n  }\n}\n\nfragment NextProject on ProjectRecord {\n  client\n  slug\n  year\n  id\n}\n\nfragment ProjectOnWorkPage on ProjectRecord {\n  ...ProjectThumb\n  multiCategory\n  client\n  slug\n  year\n  projectDescription\n  featuredImage {\n    ...Image\n  }\n  featuredVideo\n  alignment\n  themeColour {\n    hex\n  }\n}\n\nfragment ProjectThumb on ProjectRecord {\n  projectHeadline\n  projectUrl\n  multiCategory\n  featuredImage {\n    ...Image\n    ...Video\n  }\n  featuredVideo\n}\n\nfragment Image on FileField {\n  responsiveImage {\n    alt\n    src\n    sizes\n    base64\n    height\n    title\n    width\n  }\n}\n\nfragment Project on ProjectRecord {\n  multiCategory\n  client\n  id\n  slug\n  ourRole\n  projectHeadline\n  projectUrl\n  year\n  projectDescription\n  alignment\n  themeColour {\n    hex\n  }\n  openGraphImage {\n    ...Image\n  }\n  metaDescription\n  featuredImage {\n    ...Image\n    ...Video\n  }\n  featuredVideo\n  flexibleContent {\n    ...DoubleImage\n    ...TextTwoColumn\n    ...TextSingle\n    ...SingleImage\n    ...Quote\n  }\n}\n\nfragment DoubleImage on DoubleImageBlockRecord {\n  id\n  imageRight {\n    alt\n    ...Video\n    ...Image\n  }\n  videoRight\n  heightRight\n  imageLeft {\n    alt\n    ...Video\n    ...Image\n    url\n  }\n  videoLeft\n  heightLeft\n}\n\nfragment TextTwoColumn on TextTwoColumnBlockRecord {\n  id\n  textRightColumn {\n    blocks\n    links\n    value\n  }\n  textLeftColumn {\n    blocks\n    links\n    value\n  }\n}\n\nfragment TextSingle on TextSingleBlockRecord {\n  id\n  textBlockAlignment\n  textSingle {\n    blocks\n    links\n    value\n  }\n}\n\nfragment SingleImage on SingleImageBlockRecord {\n  id\n  fullwidth\n  image {\n    url\n    ...Video\n    ...Image\n  }\n  video\n}\n\nfragment Quote on QuoteBlockRecord {\n  id\n  quote {\n    value\n    links\n    blocks\n  }\n  quotee\n}']
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: 'query GetAllRDProjects {\n  allRdProjects {\n    ...RDProject\n  }\n}\n\nquery GetRDProject($slug: String) {\n  rdProject(filter: {slug: {eq: $slug}}) {\n    ...RDProject\n  }\n}\n\nfragment RDProject on RdProjectRecord {\n  projectName\n  slug\n  year\n  featuredMedia {\n    ...Image\n    ...Video\n  }\n  flexibleContent {\n    ...DoubleImage\n    ...TextSingle\n    ...SingleImage\n  }\n}'
): (typeof documents)['query GetAllRDProjects {\n  allRdProjects {\n    ...RDProject\n  }\n}\n\nquery GetRDProject($slug: String) {\n  rdProject(filter: {slug: {eq: $slug}}) {\n    ...RDProject\n  }\n}\n\nfragment RDProject on RdProjectRecord {\n  projectName\n  slug\n  year\n  featuredMedia {\n    ...Image\n    ...Video\n  }\n  flexibleContent {\n    ...DoubleImage\n    ...TextSingle\n    ...SingleImage\n  }\n}']
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: 'query getAllProjects {\n  allProjects {\n    ...ProjectOnWorkPage\n  }\n}'
